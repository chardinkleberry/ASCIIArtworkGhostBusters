...
//integer variables
        ...
        int intOne = 2100000000;
        long longOne = -2147483645;
        float floatOne = 12.12345F;
        double doubleOne = 827.182;
        char charOne = 'C';
        boolean booleanOne = true;
        String stringOne = ("hello world");

       System.out.println("/////////////////////////////////");
        System.out.println("*Charlie Liu          10/31/2007*");
        System.out.println("*                               *");
        ...
        System.out.println("*64 bit - shortOne ="+doubleOne+"\t\t*");
